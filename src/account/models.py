...
class Account(BaseModel):
    account_owner = models.ForeignKey(User, on_delete=models.SET_NULL, null=True, blank=True,
                                      related_name="owned_account")
    account_type = models.ForeignKey(AccountType, on_delete=models.SET_NULL, null=True, blank=True)
    convert_from = models.ForeignKey(Lead, on_delete=models.SET_NULL, null=True, blank=True,
                                     related_name="converted_account")
    industry = models.ForeignKey(Industry, on_delete=models.SET_NULL, null=True, blank=True, related_name="account")
